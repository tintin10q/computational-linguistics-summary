# Grammers
A grammer is a language for defining [[Languages/Languages|languages]].  If you write rules for a language then these rules are also called the grammar. The individual rules you write are called a production. Grammars define the structure of the [[Sentences|sentences]] in the language.
