...
So the apoximated tag sequence is the sequence of words with the highest posterior probabilty. If you actually calculate this with [[Bayes rule|Bayes rule]] you get $\hat{t}_{1:n} =\text{argmax}_{t_{1:n}} p(t_{1:n}) \cdot p(W_{1:n})$. 
